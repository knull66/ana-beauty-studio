...
export const dictionaries = {
  en: {
    ...
    admin: {
      ...
      contacts: "Contact",
      contactExamples:
        "Run supabase/studio-contacts.sql in the Supabase SQL Editor to enable contacts.",
    },
    adminContacts: {
      bookingTitle: "WhatsApp booking",
      bookingHelp:
        "Book opens WhatsApp with this message. Add a WhatsApp number below and mark it for booking.",
      ...
      kind: "Type",
      label: "Label",
      labelHint: "Optional. Example: Studio WhatsApp",
      value: "Value",
      order: "Order",
      visible: "Visible on the site",
      hidden: "Hidden",
      useForBooking: "Use this WhatsApp for Book",
      bookingBadge: "Booking",
      saving: "Saving…",
      saveMessageDone: "Saved",
      create: "Add",
      update: "Update",
      cancel: "Cancel",
      empty: "No contacts yet. Add email, WhatsApp, or any other detail.",
      edit: "Edit",
      remove: "Remove",
      deleteTitle: "Remove contact",
      deleteBody: "This detail will disappear from the site.",
      saveError: "Could not save the contact.",
      deleteError: "Could not remove the contact.",
      settingsError: "Could not save the booking message.",
      kinds: {
        email: "Email",
        whatsapp: "WhatsApp",
        instagram: "Instagram",
  ...
  es: {
    ...
    admin: {
      ...
      contacts: "Contacto",
      contactExamples:
        "Ejecuta supabase/studio-contacts.sql en el SQL Editor de Supabase para activar los contactos.",
    },
    adminContacts: {
      bookingTitle: "Reserva por WhatsApp",
      bookingHelp:
        "Reservar abre WhatsApp con este mensaje. Añade un número de WhatsApp y márcalo para reservas.",
      messageEn: "Mensaje (EN)",
      messageEs: "Mensaje (ES)",
      saveMessage: "Guardar mensaje",
      newContact: "Nuevo contacto",
      editContact: "Editar contacto",
      kind: "Tipo",
      label: "Etiqueta",
      labelHint: "Opcional. Ejemplo: WhatsApp del estudio",
      value: "Dato",
      order: "Orden",
      visible: "Visible en el sitio",
      hidden: "Oculto",
      useForBooking: "Usar este WhatsApp para Reservar",
      bookingBadge: "Reserva",
      saving: "Guardando…",
      saveMessageDone: "Guardado",
      create: "Añadir",
      update: "Actualizar",
      cancel: "Cancelar",
      empty: "Aún no hay contactos. Añade correo, WhatsApp u otro dato.",
      edit: "Editar",
      remove: "Quitar",
      deleteTitle: "Quitar contacto",
      deleteBody: "Este dato dejará de aparecer en el sitio.",
      saveError: "No se pudo guardar el contacto.",
      deleteError: "No se pudo quitar el contacto.",
      settingsError: "No se pudo guardar el mensaje de reserva.",
      kinds: {
        email: "Correo",
        whatsapp: "WhatsApp",
        instagram: "Instagram",
